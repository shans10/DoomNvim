...
doomnvim.lsp.capabilities = user_plugin_opts("lsp.capabilities", doomnvim.lsp.capabilities)
doomnvim.lsp.flags = user_plugin_opts "lsp.flags"
...
function doomnvim.lsp.server_settings(server_name)
  ...
  local opts = user_plugin_opts(
    ...
    user_plugin_opts("lsp.server-settings." .. server_name, {
      ...
      flags = vim.tbl_deep_extend("force", doomnvim.lsp.flags, server.flags or {}),
    }, true, "configs")
  )
...
function doomnvim.lsp.disable_formatting(client) client.resolved_capabilities.document_formatting = false end
