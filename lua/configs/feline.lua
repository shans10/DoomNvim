  ...
  components = {
    active = {
      ...
      },
      {
        ...
        { provider = provider.lsp_client_names(true), short_provider = provider.lsp_client_names(), enabled = conditional.bar_width(), icon = "   ", hl = { style = "bold" }  },
        ...
        { provider = "position" },
        { provider = provider.spacer(2) },
        { provider = "line_percentage", hl = hl.fg("TypeDef", { fg = C.yellow }) },
