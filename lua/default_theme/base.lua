local base = {
  ...
  Error = { fg = C.red, bg = C.none, style = "bold" },
  Todo = { fg = C.purple, bg = C.none, style = "bold" },
  Cursor = { fg = C.none, bg = C.none },
  ColorColumn = { fg = C.none, bg = C.grey_4 },
  CursorLineNr = { fg = C.fg, bg = C.none, style = "bold" },
  ...
  SpecialKey = { fg = C.grey_1, bg = C.none, style = "bold" },
  ...
  MatchParen = { fg = C.cyan, bg = C.bg, style = "underline" },
